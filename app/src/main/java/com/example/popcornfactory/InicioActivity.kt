...
class Inicio : AppCompatActivity() {
    var moviesList = ArrayList<Pelicula>()
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        cargaFilms()
        gv_movies.adapter = PeliculaAdapter(this,moviesList)
        gv_series.adapter = PeliculaAdapter(this,seriesList)
...
class PeliculaAdapter: BaseAdapter {
    ...
    override fun getView(p0: Int, p1: View?, p2: ViewGroup?): View {
        ...
        var vista = inflator.inflate(R.layout.movie_cell, null)
